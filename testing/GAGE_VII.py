...
class Variable:
        def __init__(self, studyName, VarName, VarDescription, Category, SubCategory, SubCategory2, Instrumentation, VarDataType, VarData, relatedVar):
        ...
        def returnVals(self):
            data = [ self.studyName, self.Varname,self.VarDescription,self.Category,self.SubCategory ,self.SubCategory2 ,self.Instrumentation,self.VarDataType, self.VarData, self.relatedVar ]
            return data

data = []
varContainer = []
x = 1
varFormat = ["StudyName","VarName", "VarDescription", "Category", "SubCategory", "SubCategory2", "Instrumentation", "VarDataType", "VarData","relatedVar"]
...
def main_driver():
    with open(filename2, 'r') as csvfile:
        ...
        #           else: instrument = str(selectInstrument(int(instrument), instrumentList))
                ...
                #ENTER DATA
                varObject =  Variable(studyName, name, description, category, sub1, sub2, instrument, varType, varData, rVar)
